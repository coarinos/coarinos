            ...
            <div className='sm:flex'>
              <div className='md:w-[100%] sm:text-left'>
                <div className='sm:mx-0'>    
                  ...
                  <p className='text-[1.2rem] md:text-[2rem] mt-3 sm:text-[1.1rem] xl:mr-[5rem] font-normal xl:text-[1.4rem] xl:w-[60%] text-white'>Revisa la documentación para ver los recursos disponibles e nuestro sito web. IB Docs es el repositorio en español mas actualizado para buscar todos los recursos del Bachillerato Internacional.</p>
                </div>
              </div>
            </div>
          </div>
